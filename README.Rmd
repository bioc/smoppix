...
This repo provides code for analyzing single-molecule spatial omics data and cell type location data using probabilistic indices as introduced in our [Genome biology paper](https://doi.org/10.1186/s13059-026-03976-5). A simple use-case is shown below, more extensive documentation can be found in the vignette.
...
A more extensive description of the _smoppix_ functionality can be found in the vignette, which can be accessed by calling
