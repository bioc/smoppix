...
#' @param Cex,Cex.main Point and title expansion factors, respectively
...
#' @param scaleBarSize A vector of length 2 defining the width and height of the scale bar,
